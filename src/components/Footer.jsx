    ...
    <div className="flex flex-col md:flex-row justify-between w-full gap-10 border-b border-gray-500/30 pb-6">
        <div className="md:max-w-96">
            ...
            <p className="mt-6 text-sm">
                Quick.ai is your all-in-one AI-powered toolkit for creators and professionals. From background removal, object erasing, and image generation to article writing, blog title ideas, and resume reviews – get smart, fast, and reliable results in seconds.
            </p>
        </div>
